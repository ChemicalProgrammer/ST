# Especificación del producto — reconstrucción con Gemini Code Assist

## Alcance y autoridad

Base auditada: ChemicalProgrammer/ST, commit 8d49bf304c6f747a5a5a7c3e5e8373290ea94110.
Esta especificación define el objetivo de reconstrucción, no certifica que todo esté
implementado. Lee también [arquitectura](ARCHITECTURE.md), [contratos](CONTRACTS.md)
y [pruebas](TEST_STRATEGY.md). Las diferencias conocidas están en [el índice](README.md).
...
Textos centralizados en TextResources.gs; recursos visuales en DesignTokens.html.
