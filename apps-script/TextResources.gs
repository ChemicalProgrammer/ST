...
var ST_TEXT_RESOURCES = {
  ...
  "client.added": " added, ",
  "client.updated_save_the_case": " updated. Save the case.",
  ...
  "comparison.vs": " vs. ",
  "comparison.configuration_can_be_compared_now_run_and_save_both_simulations_before_inte": "Configuration can be compared now. Run and save both simulations before interpreting result deltas.",
  "comparison.paired_run_both_used_seed": "Paired run: both used seed ",
  "comparison.and": " and ",
  "comparison.virtual_seconds_result_differences_can_be_attributed_to_the_saved_configura": " virtual seconds. Result differences can be attributed to the saved configuration change within this modeled run.",
  ...
  "assistant.save_your_changes_before_asking_about_this_case": "Save your changes before asking about this case.",
  "assistant.context_includes_this_saved_case_and_all_saved_simulation_results": "Context includes this saved case and all saved simulation results.",
  ...
  "view.save_a_valid_physical_line_before_running_machine_conveyor_machine_with_geo": "Save a valid physical line before running: machine → conveyor → machine, with geometry on every conveyor.",
  ...
  "view.review_the_recommendation_for_the_selected_simulation_and_create_a_proposed": "Review the recommendation for the selected simulation and create a proposed scenario.",
  ...
  "view.what_this_run_indicates": "What this run indicates",
  "view.the_recommendation_combines_this_run_s_losses_with_the_physical_conveyor_au": "The recommendation combines this run's losses with the physical conveyor audit. It creates one saved successor simulation; it does not run a design of experiments or claim an untested optimum.",
  ...
  "view.send": "Send",
  "view.sending_shares_this_saved_case_with_google_gemini_conversations_clear_when_": "Sending shares this saved case with Google Gemini. Conversations clear when you close the case, refresh or sign out.",
  ...
  "view.read_c1_c7_and_equipment_rows_a10_w_na_and_n_a_mean_not_applicable_import_u": "Read C1:C7 and equipment rows A10:W. NA and N/A mean not applicable. Import updates the selected simulation. Compare current and Sheet values, choose equipment and fields, then save the case.",
