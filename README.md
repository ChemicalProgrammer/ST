...
| [Simulation analysis and comparison](docs/17_EXPERIMENTS_AND_COMPARISON.md) | One evidence-led successor simulation, saved A/B comparison, and interpretation of dynamic versus audit results |
